/*
 * PIONEROS 4x4 - CRONOMETRO (WiFi + HUB75 + OTA)
 * Placa: SparkleIoT ESP32-S3 XH-S3E
 * Panel: HUB75 80x20 (DMA 160x10)
 *
 * ARQUITECTURA DUAL-CORE:
 *   Core 1 (loop): renderDisplay() a 20fps — NUNCA se bloquea
 *   Core 0 (tarea): HTTP polling + heartbeat — puede bloquearse sin afectar display
 *
 * ANTES DE FLASHEAR:
 *   Copiar config_a.h o config_b.h como config.h
 *
 * ARDUINO IDE:
 *   Placa: ESP32S3 Dev Module
 *   USB CDC On Boot: Enabled
 *   Puerto: el que aparezca al conectar USB1
 */
